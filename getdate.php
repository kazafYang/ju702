...
{                                                                                                                                                                             
   // echo $value . "<br>";                                                                                                                                                   
    ...
    $showinfo=$showinfo.$row[code].",".$row[min15_k].",".$row[min15_d].",".$row[min30_k].",".$row[min30_d].",".$row[min60_k].",".$row[min60_d].",".$row[kdjday_k].",".$row[kdjday_d].",".$row[kdjday_j].",".$row[now_price].",".$row[buy_one_price].",".$row[sell_one_price].";";                         
}                                                                                                                                                                             
echo $showinfo;                                                                                                                                                               
?> 
