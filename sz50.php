...
$sql = "select id,stat_time_min from $table_name order by id desc limit 1;";    
   ...
   $sql = "insert into $table_name (id,stat_date,stat_time_hour,stat_time_min,begin_point) VALUES ('$row[stat_time_min]+1','$stat_date','$time_hour','$time_min','$begin_point');";    
   if ($conn->query($sql) === TRUE) {
    echo "new inser into\n";
} else {
